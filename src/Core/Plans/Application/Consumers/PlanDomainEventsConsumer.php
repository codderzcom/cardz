...
use Cardz\Core\Plans\Domain\Events\Plan\PlanProfileChanged as DomainPlanProfileChanged;
...
use Cardz\Core\Plans\Integration\Events\{PlanAdded, PlanProfileChanged, PlanLaunched, PlanRequirementsChanged, PlanStopped};
...
final class PlanDomainEventsConsumer implements EventConsumerInterface
{
    ...
    public function consumes(): array
    {
        return [
            ...
            DomainPlanProfileChanged::class,
    ...
    public function handle(EventInterface $event): void
    {
        ...
        $integrationEvent = match (true) {
            ...
            $event instanceof DomainPlanProfileChanged => PlanProfileChanged::of($plan),
